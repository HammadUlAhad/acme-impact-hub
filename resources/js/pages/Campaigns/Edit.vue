...
const form = useForm({
    ...
    cause_category: props.campaign.cause_category,
            ...
            <div class="max-w-2xl mx-auto">
                <Card>
                    <CardHeader class="px-4 sm:px-6">
                        <CardTitle class="text-lg sm:text-xl">Edit Campaign</CardTitle>
                        <CardDescription class="text-sm sm:text-base">
                            Update your campaign details to maximize impact.
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="px-4 sm:px-6">
                        <form @submit.prevent="submit" class="space-y-4 sm:space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <!-- Current Image -->
                                <div v-if="campaign.image && !imagePreview" class="mt-4">
                                    <p class="text-sm text-gray-600 mb-2">Current image:</p>
                                    <img :src="campaign.image" alt="Current campaign image" class="w-full max-w-md h-48 object-cover rounded-md">
                                </div>
                                <!-- Image Preview -->
